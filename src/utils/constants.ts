...
export const ENVIRONMENT_VARIABLES: Record<any, EnvVariable> = {
  ...
  NODE_METRICS_HISTORY_ENABLED: {
    name: 'NODE_METRICS_HISTORY_ENABLED',
    value: process.env.NODE_METRICS_HISTORY_ENABLED,
    required: false
  },
  NODE_METRICS_SAMPLE_CRON: {
    name: 'NODE_METRICS_SAMPLE_CRON',
    value: process.env.NODE_METRICS_SAMPLE_CRON,
    required: false
  },
  NODE_METRICS_RETENTION_DAYS: {
    name: 'NODE_METRICS_RETENTION_DAYS',
    value: process.env.NODE_METRICS_RETENTION_DAYS,
    required: false
  }
}
