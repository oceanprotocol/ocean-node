...
import { validateFilesStructure } from '../../components/core/downloadHandler.js'
...
describe('Should validate files structure for download', () => {
  ...
  it('should NOT validate "nftAddress" and "datatokenAddress" from files', async () => {
    ...
    // datatokenAddress: '0x32b24528675172841d89BBA7504A930B049aBd30',
    // nftAddress: '0x3b7aE751aBA144e9A0ffc5A5C1D00bB4055A7bDc',
    ...
    assert(decryptedFileData.datatokenAddress === otherDatatokenAddress)
    assert(decryptedFileData.nftAddress === otherNFTAddress)
  })
